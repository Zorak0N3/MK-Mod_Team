...
{
	 explode(gX+3,gY,gZ,0.1);
      explode(gX-3,gY,gZ,0.1);
      explode(gX,gY,gZ+3,0.1);
      explode(gX,gY,gZ-3,0.1);
      explode(gX-3,gY,gZ-3,0.1);
      explode(gX+3,gY,gZ+3,0.1);
      explode(gX-3,gY,gZ+3,0.1);
      explode(gX+3,gY,gZ-3,0.1);
      explode(gX,gY+3,gZ,0.1);
      explode(gX+3,gY+1,gZ,0.1);
      explode(gX-3,gY+1,gZ,0.1);
      explode(gX,gY+1,gZ+3,0.1);
      explode(gX,gY+1,gZ-3,0.1);
      explode(gX-3,gY+1,gZ-3,0.1);
      explode(gX+3,gY+1,gZ+3,0.1);
      explode(gX-3,gY+1,gZ+3,0.1);
      explode(gX+3,gY+1,gZ-3,0.1);
	 setTile(gX,gY,gZ,0);
