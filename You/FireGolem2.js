...
{
	setTile(gX,gY,gZ,51);
	 setTile(gX+1,gY,gZ,51);
	 setTile(gX-1,gY,gZ,51);
	 setTile(gX,gY,gZ+1,51);
	 setTile(gX,gY,gZ-1,51);
	 setTile(gX+1,gY,gZ+1,51);
	 setTile(gX-1,gY,gZ-1,51);
	 setTile(gX+1,gY,gZ-1,51);
	 setTile(gX-1,gY,gZ+1,51);
	 setTile(gX+2,gY,gZ,51);
	 setTile(gX-2,gY,gZ,51);
	 setTile(gX,gY,gZ+2,51);
	 setTile(gX,gY,gZ-2,51);
	 setTile(gX+2,gY,gZ+2,51);
	 setTile(gX-2,gY,gZ-2,51);
	 setTile(gX+2,gY,gZ-2,51);
	 setTile(gX-2,gY,gZ+2,51);
	 
	 	setTile(gX,gY+1,gZ,51);
	 setTile(gX+1,gY+1,gZ,51);
	 setTile(gX-1,gY+1,gZ,51);
	 setTile(gX,gY+1,gZ+1,51);
	 setTile(gX,gY+1,gZ-1,51);
	 setTile(gX+1,gY+1,gZ+1,51);
	 setTile(gX-1,gY+1,gZ-1,51);
	 setTile(gX+1,gY+1,gZ-1,51);
	 setTile(gX-1,gY+1,gZ+1,51);
	 setTile(gX+2,gY+1,gZ,51);
	 setTile(gX-2,gY+1,gZ,51);
	 setTile(gX,gY+1,gZ+2,51);
	 setTile(gX,gY+1,gZ-2,51);
	 setTile(gX+2,gY+1,gZ+2,51);
	 setTile(gX-2,gY+1,gZ-2,51);
	 setTile(gX+2,gY+1,gZ-2,51);
	 setTile(gX-2,gY+1,gZ+2,51);
	 
	 setTile(gX,gY+2,gZ,51);
	 setTile(gX+1,gY+2,gZ,51);
	 setTile(gX-1,gY+2,gZ,51);
	 setTile(gX,gY+2,gZ+1,51);
	 setTile(gX,gY+2,gZ-1,51);
	 setTile(gX+1,gY+2,gZ+1,51);
	 setTile(gX-1,gY+2,gZ-1,51);
	 setTile(gX+1,gY+2,gZ-1,51);
	 setTile(gX-1,gY+2,gZ+1,51);
	 setTile(gX+2,gY+2,gZ,51);
	 setTile(gX-2,gY+2,gZ,51);
	 setTile(gX,gY+2,gZ+2,51);
	 setTile(gX,gY+2,gZ-2,51);
	 setTile(gX+2,gY+2,gZ+2,51);
	 setTile(gX-2,gY+2,gZ-2,51);
	 setTile(gX+2,gY+2,gZ-2,51);
	 setTile(gX-2,gY+2,gZ+2,51);
	 
	 setTile(gX,gY+3,gZ,51);
	 setTile(gX+1,gY+3,gZ,51);
	 setTile(gX-1,gY+3,gZ,51);
	 setTile(gX,gY+3,gZ+1,51);
	 setTile(gX,gY+3,gZ-1,51);
	 setTile(gX+1,gY+3,gZ+1,51);
	 setTile(gX-1,gY+3,gZ-1,51);
	 setTile(gX+1,gY+3,gZ-1,51);
	 setTile(gX-1,gY+3,gZ+1,51);
	 setTile(gX+2,gY+3,gZ,51);
	 setTile(gX-2,gY+3,gZ,51);
	 setTile(gX,gY+3,gZ+2,51);
	 setTile(gX,gY+3,gZ-2,51);
	 setTile(gX+2,gY+3,gZ+2,51);
	 setTile(gX-2,gY+3,gZ-2,51);
	 setTile(gX+2,gY+3,gZ-2,51);
	 setTile(gX-2,gY+4,gZ+2,51);
